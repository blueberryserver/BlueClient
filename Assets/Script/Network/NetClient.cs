...
public class NetClient : MonoBehaviour
{
    ...
    // delegate
    public delegate void OnConnected(NetClient netClient, SocketError errorCode);
	public delegate void OnClosed(NetClient netClient);
